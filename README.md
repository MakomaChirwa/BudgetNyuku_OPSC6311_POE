...
Splash Screen (2 seconds) → Welcome screen
...
Tap "Register" → Success message

Login with your credentials

Adding an Expense

Method 1: Dashboard → "Add Expense" card

Method 2: Bottom Navigation → "Add" tab
...
Optional: Take or select photo

Tap "Add Expense"

Creating a Savings Goal

Menu → Goal Tracker → Tap + FAB
...
To update progress: Tap "Add Savings" on any goal → Enter amount → Save

Setting Budget Goals

Bottom Navigation → "Budget" tab

├── Enter Minimum Monthly Goal

├── Enter Maximum Monthly Goal

├── Tap "Save Budget Settings"
...
| Name | Role |
|--------|--------|
| Molebogeng Thupi | Developer, UI/UX Designer, Database Designer/ Administrator |
| Makoma Chirwa | Developer, UI/UX Designer, Database Designer/ Administrator |
| Keabetswe Mphago | Developer, UI/UX Designer, Database Designer/ Administrator |
...
**Email:** ST10349188@rcconnect.edu.za
**GitHub:** https://github.com/Lebo2308
